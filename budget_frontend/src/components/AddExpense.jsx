...
function AddExpense() {
  ...
  return ( 
    ...
    <div className="card flex flex-col items-center justify-center p-6 mt-4 rounded-xl transition hover:scale-105">
      <div onClick={() => setIsModalOpen(true)} className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-400 rounded-lg p-6 w-48 h-48 hover:bg-gray-50 cursor-pointer transition-all">
